        ...
        <div align='center' className='grid-container'>
          ...
          <fieldset>
            ...
            <button className={one} onClick={() => {toggleCategoryItem('billing', 'subscription'); this.toggle(one, 'one');}}>
              <img className='estimatorIcons' alt='Button Icon' src={require("../../images/subscription_plan.svg")}/>
            </button>
          </fieldset>
          ...
          <fieldset>
            ...
            <button className={two} onClick={() => {toggleCategoryItem('billing', 'payment_processing'); this.toggle(two, 'two');}}>
              <img className='estimatorIcons' alt='Button Icon' src={require("../../images/payment_processing.svg")}/>
            </button>
          </fieldset>
          ...
          <fieldset>
            ...
            <button className={three} onClick={() => {toggleCategoryItem('billing', 'shopping_cart'); this.toggle(three, 'three');}}>
              <img className='estimatorIcons' alt='Button Icon' src={require("../../images/shopping_cart.svg")}/>
            </button>
          </fieldset>
          ...
          <fieldset>
            ...
            <button className={four} onClick={() => {toggleCategoryItem('billing', 'user_marketplace'); this.toggle(four, 'four');}}>
              <img className='estimatorIcons' alt='Button Icon' src={require("../../images/user_marketplace.svg")}/>
            </button>
          </fieldset>
          ...
          <fieldset>
            ...
            <button className={five} onClick={() => {toggleCategoryItem('billing', 'product_management'); this.toggle(five, 'five');}}>
              <img className='estimatorIcons' alt='Button Icon' src={require("../../images/product_management.svg")}/>
            </button>
          </fieldset>
