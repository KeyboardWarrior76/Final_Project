    ...
    <>
      ...
      <fieldset>
        ...
        <button className={one} style={{fontSize: 50, fontWeight: 'bold', display: 'flex'}} onClick={() => {toggleCategoryItem('analytic', 'cms'); this.toggle(one, 'one');}}>
          <img className='estimatorIcons' alt='Button Icon' src={require("../../images/cms.svg")}/>
        </button>
      </fieldset>
      ...
      <fieldset>
        ...
        <button className={two} onClick={() => {toggleCategoryItem('analytic', 'admin'); this.toggle(two, 'two');}}>
          <img className='estimatorIcons' alt='Button Icon' src={require("../../images/admin.svg")}/>
        </button>
      </fieldset>
      ...
      <fieldset>
        ...
        <button className={four} onClick={() => {toggleCategoryItem('analytic', 'intercom'); this.toggle(four, 'four');}}>
          <img className='estimatorIcons' alt='Button Icon' src={require("../../images/intercom.svg")}/>
        </button>
      </fieldset>
      ...
      <fieldset>
        ...
        <button className={five} onClick={() => {toggleCategoryItem('analytic', 'usage'); this.toggle(five, 'five');}}>
          <img className='estimatorIcons' alt='Button Icon' src={require("../../images/usage.svg")}/>
        </button>
      </fieldset>
      ...
      <fieldset>
        ...
        <button className={six} onClick={() => {toggleCategoryItem('analytic', 'crash_report'); this.toggle(six, 'six');}}>
          <img className='estimatorIcons' alt='Button Icon' src={require("../../images/crash_report.svg")}/>
        </button>
      </fieldset>
      ...
      <fieldset>
        ...
        <button className={seven} onClick={() => {toggleCategoryItem('analytic', 'performance'); this.toggle(seven, 'seven');}}>
          <img className='estimatorIcons' alt='Button Icon' src={require("../../images/performance.svg")}/>
        </button>
      </fieldset>
      ...
      <fieldset>
        ...
        <button className={eight} onClick={() => { toggleCategoryItem('analytic', 'multilingual'); this.toggle(eight, 'eight');}}>
          <img className='estimatorIcons' alt='Button Icon' src={require("../../images/multilingual.svg")}/>
        </button>
      </fieldset>
